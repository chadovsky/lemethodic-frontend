...
const STATIC_ROUTES: RouteSpec[] = [
  ...
  { path: '/l-examen/diagnostic/results', slug: 'l-examen-diagnostic-results', isDynamic: false },
  ...
  { path: '/la-methode/intro', slug: 'la-methode-intro', isDynamic: false },
  { path: '/onboarding', slug: 'onboarding', isDynamic: false },
  { path: '/onboarding/waitlist', slug: 'onboarding-waitlist', isDynamic: false },
  { path: '/l-examen/expression-orale', slug: 'l-examen-expression-orale', isDynamic: false },
  { path: '/l-examen/expression-orale/tache-1', slug: 'l-examen-expression-orale-tache-1', isDynamic: false },
  { path: '/l-examen/expression-orale/tache-2', slug: 'l-examen-expression-orale-tache-2', isDynamic: false },
  { path: '/l-examen/expression-ecrite', slug: 'l-examen-expression-ecrite', isDynamic: false },
  { path: '/l-examen/expression-ecrite/history', slug: 'l-examen-expression-ecrite-history', isDynamic: false },
...
const DYNAMIC_ROUTES: RouteSpec[] = [
  ...
  { path: '/l-examen/diagnostic/tache/1', slug: 'l-examen-diagnostic-tache-n', isDynamic: true, note: '[n]=1' },
  { path: '/la-methode/test-lesson', slug: 'la-methode-id', isDynamic: true, note: '(app)/la-methode/[id]' },
  { path: '/la-methode/lesson/test-id', slug: 'la-methode-lesson-id', isDynamic: true, note: '[id]' },
  { path: '/la-methode/lesson/test-id/quiz', slug: 'la-methode-lesson-quiz', isDynamic: true, note: '[id]/quiz' },
  { path: '/l-examen/expression-orale/tache-1/test-topic', slug: 'l-examen-expression-orale-tache1-topic', isDynamic: true, note: '[topic]' },
  { path: '/l-examen/expression-orale/tache-2/test-scenario', slug: 'l-examen-expression-orale-tache2-scenario', isDynamic: true, note: '[scenario]' },
  { path: '/l-examen/expression-orale/tache-3/test-topic', slug: 'l-examen-expression-orale-tache3-topic', isDynamic: true, note: '[topic]' },
  { path: '/l-examen/expression-orale/feedback/test-session', slug: 'l-examen-expression-orale-feedback-session', isDynamic: true, note: '[session]' },
  ...
  { path: '/l-examen/expression-ecrite/test-prompt', slug: 'l-examen-expression-ecrite-prompt-id', isDynamic: true, note: '[prompt_id]' },
]
