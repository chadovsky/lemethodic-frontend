...
describe('LessonDetail', () => {
  ...
  it('lesson 1 - renders no previous-lesson button, only a next button linking to /la-methode/lecon-2', () => {
    ...
    expect(next).toHaveAttribute('href', '/la-methode/lecon-2')
  })
  ...
  it('lesson 27 - renders no next-lesson button, only a prev button linking to /ecole/26', () => {
    ...
    expect(prev).toHaveAttribute('href', '/la-methode/lecon-26')
  })

  it('mid lesson (5) - renders both prev and next buttons', () => {
    render(<LessonDetail lesson={LESSON_5} />)
    expect(screen.getByTestId('lesson-nav-prev')).toHaveAttribute('href', '/la-methode/lecon-4')
    expect(screen.getByTestId('lesson-nav-next')).toHaveAttribute('href', '/la-methode/lecon-6')
  })
