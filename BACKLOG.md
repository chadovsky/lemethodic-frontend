...
## New tickets — 2026-06-02 (complete-site doctrine, canon cleanup, payment, onboarding)

### F-359: [FE] Coming-soon state system (bientot config + UI pattern)
Milestone: M2

**Priority:** HIGH — must ship before any surface is lit as bientot
**Status:** QUEUED
**Filed:** 2026-06-02
...
**Dependencies:** F-359 (bientot config), F-321 (content — blocks the live state, not the route shell)
**Owner:** Frontend Engineering (Chadi supplies content via F-321)

---

### F-364: [FE+BE] LemonSqueezy integration — Free, Core, and Sprint subscription tiers
Milestone: M6
...
**Dependencies:** F-359 (site-complete gate), F-326 (subscriptionStatus on User — reuse the enum, sourced from LemonSqueezy not Stripe)
**Supersedes:** P-106.x, F-300e, F-300f, F-333 (all marked obsolete — Stripe references removed)
**Owner:** Frontend Engineering (Chadi: LemonSqueezy account + product setup)

---

### F-365: [FE+BE] Onboarding /bienvenue — Target Profile capture
Milestone: M2
...
### F-366: [FE] Four skills present in ile activities — oral live, others bientot
Milestone: M3
