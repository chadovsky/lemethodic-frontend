...
**Status:** In review -- branch `feat/nav-consolidation`, **do not merge** (awaiting Chadi approval of the Vercel preview). Gates: full unit 574/574, `pnpm build` clean, e2e (CI authoritative; local f-479 26/26 + nav regression set green; the 4 f-448 blips in the combined local run were the documented dev-server parallel-load flakes -- pass clean in isolation, desktop 12/12 + mobile 12/12). SHA + CI + preview reported in the dispatch message.
