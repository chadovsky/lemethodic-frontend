...
**Status:** Built on `feat/f-482-pre-paint-theme-script`; pending Chadi go for squash-merge (per brief, merge only on confirmation). Squash SHA to be filled in at merge.
