...
> This is the retired v2 (Atelier Français) spec, retained for audit only. Do not build against it.
> The current visual constitution is repo-root `DESIGN.md` (v3). Lineage: v1 (mustard/ochre) → v2 (Atelier Français, this file) → v3 (Apple-lean).
