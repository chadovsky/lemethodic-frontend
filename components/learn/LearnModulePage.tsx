...
const COPY = {
  fr: {
    ...
    backToEcole: "Retour à La Méthode",
  ...
  en: {
    ...
    backToEcole: "Back to La Méthode",
  ...
  if (loadError && !moduleData) {
    return (
      <ErrorScreen
        ...
        onBack={() => router.push('/cours/methode-tcf-canada')}
      />
    )
  }
  if (!moduleData) {
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 12 }}>
            {linkedLessonNumber != null ? (
              <>
                <button
                  type="button"
                  onClick={() => router.push(`/cours/methode-tcf-canada/lecon-${linkedLessonNumber}`)}
                  style={{
                    width: '100%',
                    minHeight: 56,
                    borderRadius: 16,
